...
This tool supports a *label-switching* variant of concept drift: the underlying classification function stays the same while the *label assignment* is changed by applying a mapping to all labels at a drift point.
